                    ...
                    while ((folder_list = g_variant_iter_next_value(folder_list_object_iter))) {
                        ...
                        while ((item = g_variant_iter_next_value(iter))) {
                            g_print(
                                    ...
                                    g_variant_get_string(g_variant_lookup_value(item, "Group-perm", G_VARIANT_TYPE("s")), NULL),
                                    g_variant_get_string(g_variant_lookup_value(item, "Other-perm", G_VARIANT_TYPE("s")), NULL),
                                    g_variant_get_string(g_variant_lookup_value(item, "Accessed", G_VARIANT_TYPE("s")), NULL),
                                    g_variant_get_string(g_variant_lookup_value(item, "Modified", G_VARIANT_TYPE("s")), NULL),
                                    g_variant_get_string(g_variant_lookup_value(item, "Created", G_VARIANT_TYPE("s")), NULL)
                                    );
